...
![Globe](https://maxcdn.icons8.com/Color/PNG/24/Maps/globe-24.png "Globe") means that **it’s *webapp/webservice***.  
![Android OS](https://maxcdn.icons8.com/Color/PNG/24/Operating_Systems/android_os_copyrighted-24.png "Android OS") means that **runs on *Android***.  
![iOS Logo](https://maxcdn.icons8.com/Color/PNG/24/Logos/ios_logo-24.png "iOS Logo") means that **runs on *iOS***.  
![Mac OS X](https://maxcdn.icons8.com/Android_L/PNG/24/Operating_Systems/mac_os-24.png "Mac OS X") means that **runs on *macOS***.  
![Linux](https://maxcdn.icons8.com/Color/PNG/24/Operating_Systems/linux-24.png "Linux") means that **runs on *Linux***.  
![Windows](https://maxcdn.icons8.com/Color/PNG/24/Operating_Systems/windows8_copyrighted-24.png "Windows") means that **runs on *Windows***.  
...
-   [mdp](https://github.com/visit1985/mdp) - Command-line based Markdown presentation tool. :gem: *Like PowerPoint and Vim but with Markdown!* ![Mac OS X](https://maxcdn.icons8.com/Android_L/PNG/24/Operating_Systems/mac_os-24.png "Mac OS X") ![Linux](https://maxcdn.icons8.com/Color/PNG/24/Operating_Systems/linux-24.png "Linux")
