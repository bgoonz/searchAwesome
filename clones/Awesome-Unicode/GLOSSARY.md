...
<strong><a id="character_encoding_scheme" href="#character_encoding_scheme">Character Encoding Scheme</a></strong>: A *character encoding form* plus byte serialization. There are seven character encoding schemes in Unicode: UTF-8, UTF-16, UTF-16BE, UTF-16LE, UTF-32, UTF-32BE, and UTF-32LE.
...
<strong><a id="coded_character_set" href="#coded_character_set">Coded Character Set</a></strong>: A character set in which each character is assigned a numeric code point. Frequently abbreviated as *character set, charset*, or *code set*; the acronym *CCS* is also used.
...
<strong><a id="majuscule" href="#majuscule">Majuscule</a></strong>: Synonym for *uppercase*. (See *[case](GLOSSARY.md#case)*.)
...
<strong><a id="octet" href="#octet">Octet</a></strong>: An ordered sequence of eight bits considered as a unit. The Unicode Standard follows current industry practice in referring to an octet as a *byte*. (See *[byte](GLOSSARY.md#byte)*.)
...
<strong><a id="pua" href="#pua">PUA</a></strong>: Acronym for *Private Use Area*.
...
<strong><a id="scalar_value" href="#scalar_value">Scalar Value</a></strong>: (See *[Unicode scalar value](GLOSSARY.md#unicode_scalar_value)*.)
...
<strong><a id="unassigned_code_point" href="#unassigned_code_point">Unassigned Code Point</a></strong>: Synonym for *[reserved code point](GLOSSARY.md#reserved_code_point)*.
...
<strong><a id="unicode_encoding_scheme" href="#unicode_encoding_scheme">Unicode Encoding Scheme</a></strong>: A specified byte serialization for a Unicode encoding form, including the specification of the handling of a *byte order mark* (BOM), if allowed. (See definition D94 in [Section 3.10, Unicode Encoding Schemes](http://www.unicode.org/versions/Unicode7.0.0/ch03.pdf#G28070).)

<strong><a id="locale_data_markup_language" href="#locale_data_markup_language">Unicode Locale Data Markup Language</a></strong>: The XML specification for the exchange of locale data, defined by [Unicode Technical Standard \#35, "Unicode Locale Data Markup Language (LDML)."](http://www.unicode.org/reports/tr35/) (See also [*Unicode Common Locale Data Repository*](GLOSSARY.md#common_locale_data_repository).)

<strong><a id="unicode_scalar_value" href="#unicode_scalar_value">Unicode Scalar Value</a></strong>: Any Unicode *[code point](GLOSSARY.md#code_point)* except high-surrogate and low-surrogate code points. In other words, the ranges of integers 0 to D7FF<sub>16</sub> and E000<sub>16</sub> to 10FFFF<sub>16</sub> inclusive. (See definition D76 in [Section 3.9, Unicode Encoding Forms](http://www.unicode.org/versions/Unicode7.0.0/ch03.pdf#G7404).)

<strong><a id="unicode_signature" href="#unicode_signature">Unicode Signature</a></strong>: An implicit marker to identify a file as containing Unicode text in a particular encoding form. An initial *byte order mark* ([BOM](GLOSSARY.md#BOM)) may be used as a Unicode signature.
...
<strong><a id="unicode_transformation_format" href="#unicode_transformation_format">Unicode Transformation Format</a></strong>: An ambiguous synonym for either *[Unicode encoding form](GLOSSARY.md#unicode_encoding_form)* or *[Unicode encoding scheme](GLOSSARY.md#unicode_encoding_scheme)*. The latter terms are now preferred.
...
<strong><a id="uppercase" href="#uppercase">Uppercase</a></strong>: (See *[case](GLOSSARY.md#case)*.)
...
<strong><a id="user_defined_character" href="#user_defined_character">User-Defined Character</a></strong>: (See *[EUDC](GLOSSARY.md#eudc)*.)
...
<strong><a id="utf" href="#utf">UTF</a></strong>: Acronym for *Unicode* (or *UCS*) *Transformation Format*.

<strong><a id="UTF_2" href="#UTF_2">UTF-2</a></strong>: Obsolete name for *[UTF-8](GLOSSARY.md#UTF_8)*.

<strong><a id="UTF_7" href="#UTF_7">UTF-7</a></strong>: Unicode (or UCS) Transformation Format, 7-bit encoding form, specified by *RFC-2152*.
...
<strong><a id="utn" href="#utn">UTN</a></strong>: Acronym for *Unicode Technical Note*.

<strong><a id="utr" href="#utr">UTR</a></strong>: Acronym for *Unicode Technical Report*.

<strong><a id="uts" href="#uts">UTS</a></strong>: Acronym for *Unicode Technical Standard*.

### V

<strong><a id="varia" href="#varia">Varia</a></strong>: Greek term for grave accent, used in polytonic Greek character names.

<strong><a id="virama" href="#virama">Virama</a></strong>: From Sanskrit. The name of a sign used in many Indic and other Brahmi-derived scripts to suppress the inherent vowel of the consonant to which it is applied, thereby generating a *dead consonant*. (See [Section 12.1, Devanagari](http://www.unicode.org/versions/Unicode7.0.0/ch12.pdf#G12284).) The sign varies in shape from script to script, and may be known by other names in various languages. For example, in Hindi it is known as *hal* or *[halant](GLOSSARY.md#halant)*, in Bangla it is called *hasant*, and in Tamil it is called *pulli*.
...
<strong><a id="visual_order" href="#visual_order">Visual Order</a></strong>: Characters ordered as they are presented for reading. (Contrast with *[logical order](GLOSSARY.md#logical_order)*.)
...
<strong><a id="vowel" href="#vowel">Vowel</a></strong>: In Korean, a jamo character with the Hangul\_Syllable\_Type property value Vowel\_Jamo (in the range U+1161..U+11A2 or U+1160 <span style="font-variant:small-caps;"> hangul jungseong filler</span>). Abbreviated as ***V***. (See definition D125 in [Section 3.12, Conjoining Jamo Behavior](http://www.unicode.org/versions/Unicode7.0.0/ch03.pdf#G24646).)
...
<strong><a id="wchar_t" href="#wchar_t">wchar\_t</a></strong>: The ANSI C defined *wide character* type, usually implemented as either 16 or 32 bits. ANSI specifies that wchar\_t be an integral type and that the C language source character set be mappable by simple extension (zero- or sign-extension).
...
<strong><a id="XML" href="#XML">XML</a></strong>: eXtensible Markup Language. A subset of SGML constituting a particular text markup language for interchange of structured data. The Unicode Standard is the reference character set for XML content. (See also *[SGML](GLOSSARY.md#SGML)* and *[rich text](GLOSSARY.md#rich_text)*.) XML is a trademark of the World Wide Web Consortium.
...
<strong><a id="y_variant" href="#y_variant">Y-variant</a></strong>: Two CJK unified ideographs with identical semantics and non-unifiable shapes, for example, U+732B and U+8C93. (See *[Z-variant](GLOSSARY.md#z_variant.).*)

### Z

<strong><a id="z_variant" href="#z_variant">Z-variant</a></strong>: Two CJK unified ideographs with identical semantics and unifiable shapes, for example, U+8AAA and U+8AAC. (See *[Y-variant](GLOSSARY.md#y_variant)*.)

<strong><a id="zenkaku" href="#zenkaku">Zenkaku</a></strong>: (See *[fullwidth](GLOSSARY.md#fullwidth)*.)

<strong><a id="zero_width" href="#zero_width">Zero Width</a></strong>: Characteristic of some spaces or format control characters that do not advance text along the horizontal baseline. (See *[nonspacing mark](GLOSSARY.md#nonspacing_mark)*.)
  
