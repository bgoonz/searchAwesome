$(document).ready(function () {
  var c,
    ...
    v = $(".readme-container"),
    l = $(".search-result"),
    s = $(".search-input-section"),
    b = $(".mui-dropdown__menu"),
    w = $(".mui-dropdown");
  function d(e, t, a) {
    ...
    for (u = 0, p = s.length; u < p; ++u) {
      $(s[u])
        .attr({ class: "cate-anchor", "data-anchor": $(s[u]).attr("href") })
        .removeAttr("href");
    }
        ...
        "H1" === (n = $(o[u]).parent()[0].nodeName)
          ...
          b.append(
            '<li class="' +
              ...
              '">' +
              f +
              $(o[u]).parent("h6, h5, h4, h3, h2, h1").text() +
              "</a></li>"
          );
      }
    ...
    for (
      ...
      void 0 === (g = $(r[u]).attr("href")) ||
        k(g) ||
        ((g = g.startsWith("/") ? g : "/" + g), $(r[u]).attr({ href: l + g })),
        $(r[u]).attr({ target: "_blank" });
    }
  }
  function a(e, t) {
    var n = "https://github.com/" + e + "/" + t;
    if (
      ((h = "awesome" === t ? 1 : 0),
      (jsonURL =
      ...
      v.html('<div class="sk-spinner sk-spinner-pulse"></div>'),
        (function (e, t, a, n, r) {
          var o = "https://api.github.com/repos/" + e + "/" + t + "/readme";
          $.ajax({
            url: o,
  ...
  $("input").on("input", function (e) {
    var t = $(e.target).hasClass("cate-input"),
      a = $(this).val();
  ...
  var e = new (Backbone.Router.extend({
    routes: { "repos/:maintainer/:repo": "getRepos", "": "getAwesome" },
  }))();
  function k(e) {
  ...
  function C(e) {
    var t = $(e.target).data("anchor"),
      a = $(t).offset().top - $("#header").height();
    $("html, body").animate({ scrollTop: a }, 300);
  }
  e.on("route:getRepos", function (e, t) {
    $(".search-holder").html("Search " + t), a(e, t);
  }),
    e.on("route:getAwesome", function () {
  ...
  jQuery(function (a) {
    var e = a("body"),
      n = a("#sidedrawer");
    a(".js-show-sidedrawer").on("click", function () {
      var e = {
          onclose: function () {
      ...
      a(".js-hide-sidedrawer").on("click", function () {
        e.toggleClass("hide-sidedrawer");
      }),
      a(".to-top-arrow").click(function () {
