...
!(function (t) {
  function e(t, n) {
    ...
    var i, o, s, r;
    for (i = 0, r = ["sort", "shouldSort"], o = r.length; o > i; i++)
      (s = r[i]), (this.options[s] = s in n ? n[s] : e.defaultOptions[s]);
    for (
      i = 0,
        r = ["searchFn", "sortFn", "keys", "getFn", "include"],
        o = r.length;
      o > i;
      i++
    )
  ...
  (n.defaultOptions = {
    ...
    (n.prototype.search = function (t) {
      ...
      for (
        -1 != u &&
          ((f = Math.min(this._bitapScore(0, u), f)),
          (u = t.lastIndexOf(this.pattern, l + this.patternLen)),
          -1 != u && (f = Math.min(this._bitapScore(0, u), f))),
          u = -1,
          e = 0;
        e < this.patternLen;
        e++
        ...
        for (i = 0, o = d; o > i; )
          this._bitapScore(e, l + o) <= f ? (i = o) : (d = o),
          ...
          if (
            ...
            0 === e
              ...
              : (a[n] =
                  ...
                  (((h[n + 1] | h[n]) << 1) | 1) |
                  h[n + 1]),
            a[n] & this.matchmask && ((g = this._bitapScore(e, n - 1)), f >= g))
          ) {
      ...
      return { isMatch: u >= 0, score: g };
    });
  var i = function (t, e, n) {
      var s, r, a;
      if (e) {
        (a = e.indexOf(".")),
          -1 !== a ? ((s = e.slice(0, a)), (r = e.slice(a + 1))) : (s = e);
        var h = t[s];
        if (h)
            ...
            if ("string" == typeof t)
              (i = r.search(t)),
                i.isMatch &&
                  ((s = u[n]),
                  s
                    ? (s.score = Math.min(s.score, i.score))
                    : ((u[n] = { item: e, score: i.score }), f.push(u[n])));
            else if (o.isArray(t))
              for (var a = 0; a < t.length; a++) g(t[a], e, n);
        };
      if ("string" == typeof a[0]) for (var m = 0; h > m; m++) g(a[m], m, m);
      else
        for (var m = 0; h > m; m++)
        ...
        var v = p.id
          ...
          y = function (t) {
            ...
            if (p.include.length > 0) {
              e = { item: f[t].item };
              for (var t = 0; t < p.include.length; t++) {
                var n = p.include[t];
                e[n] = f[t][n];
              }
            } else e = f[t].item;
